                ...
                <table id="payslips_table" data-toggle="table" data-loading-template="loadingTemplate" data-url="/payslips/list" data-icons-prefix="bx" data-icons="icons" data-show-refresh="true" data-total-field="total" data-trim-on-search="false" data-data-field="rows" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true" data-side-pagination="server" data-show-columns="true" data-pagination="true" data-sort-name="id" data-sort-order="desc" data-mobile-responsive="true" data-query-params="queryParams">
                    <thead>
                        <tr>
                            ...
                            <th data-field="user" data-visible="{{ (in_array('user', $visibleColumns) || empty($visibleColumns)) ? 'true' : 'false' }}" data-sortable="false"><?= get_label('member', 'Member') ?></th>
                            ...
                            <th data-field="ot_hours" data-sortable="true" data-visible="{{ (in_array('ot_hours', $visibleColumns)) ? 'true' : 'false' }}"><?= get_label('ot_hours', 'Over time hours') ?></th>
                            <th data-field="ot_rate" data-sortable="true" data-visible="{{ (in_array('ot_rate', $visibleColumns)) ? 'true' : 'false' }}"><?= get_label('ot_rate', 'Over time rate') ?></th>
                            <th data-field="ot_payment" data-sortable="true" data-visible="{{ (in_array('ot_payment', $visibleColumns)) ? 'true' : 'false' }}"><?= get_label('ot_payment', 'Over time payment') ?></th>
