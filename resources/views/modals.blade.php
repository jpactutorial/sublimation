                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="form-check form-switch mb-2">
                            <input class="form-check-input" type="checkbox" id="partialLeave" name="partialLeave">
                            <label class="form-check-label" for="partialLeave"><?= get_label('partial_leave', 'Partial Leave') ?>?</label>
                        </div>
                    </div>
                    ...
                    <div class="col-12 mb-3">
                        <label class="form-label"><?= get_label('visible_to', 'Visible To') ?> <i class='bx bx-info-circle text-primary' data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="top" title="" data-bs-original-title="{{get_label('leave_visible_to_info', 'Including You, Admin, and Leave Editors, Selected Users Will Be Able to Know When You\'re on Leave.')}}"></i></label>
                        <select class="form-control js-example-basic-multiple" name="visible_to_ids[]" multiple="multiple" data-placeholder="<?= get_label('select_users', 'Select Users') ?>">
                            @isset($users)
                            @foreach ($users as $user)
...
@if (Request::is('projects/list') || Request::is('home') || Request::is('users/profile/*') || Request::is('clients/profile/*') || Request::is('tasks') || Request::is('projects/information/*'))
...
@endif
@if (Request::is('users') || Request::is('clients') || Request::is('projects/list') || Request::is('tasks'))
