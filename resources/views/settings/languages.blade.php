            ...
            <div class="row">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="mb-3 mt-2">
                        ...
                        {!! create_label('leave_visible_to_info', 'Including You, Admin, and Leave Editors, Selected Users Will Be Able to Know When You\'re on Leave.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        {!! create_label('leave_visible_to_info_1', 'Including You, Admin, and Leave Editors, Users Which Will Be Able to Know When You\'re on Leave.',Session::get('locale')) !!}
                        ...
                        {!! create_label('leave_request_creation_email_info', 'This Template Will Be Used for the Email Sent to the Admin and Leave Editors Upon the Creation of a Leave Request.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        ...
                        {!! create_label('leave_request_status_updation_email_info', 'This Template Will Be Used for the Email Sent to the Admin/Leave Editors/Requestee Upon the Status Updation of a Leave Request.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        ...
                        {!! create_label('leave_request_creation_sms_info', 'This Template Will Be Used for the SMS Sent to the Admin and Leave Editors Upon the Creation of a Leave Request.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        ...
                        {!! create_label('leave_request_status_updation_sms_info', 'This Template Will Be Used for the SMS Sent to the Admin/Leave Editors/Requestee Upon the Status Updation of a Leave Request.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                        {!! create_label('project_status_updation_email_info', 'This Template Will Be Used for the Email Sent to the Users/Clients Upon the Status Updation of a Project.',Session::get('locale')) !!}
                        ...
                        <div class="row">
                        {!! create_label('task','Task',Session::get('locale')) !!}
                        {!! create_label('project_status_updation_sms_info', 'This Template Will Be Used for the SMS Sent to the Users/Clients Upon the Status Updation of a Project.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        ...
                        {!! create_label('task_status_updation_sms_info', 'This Template Will Be Used for the SMS Sent to the Users/Clients Upon the Status Updation of a Task.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
