                        ...
                        <div class="tab-content px-0">
                                    ...
                                    <div class="tab-pane fade" id="email-project">
                                        ...
                                        <div class="tab-content px-0">
                                            ...
                                            <div class="tab-pane fade" id="email-project-status-updation">
                                                ...
                                                ->first();
                                                @endphp
                                                <small class="text-light fw-semibold mb-1"><?= get_label('project_status_updation_email_info', 'This Template Will Be Used for the Email Sent to the Users/Clients Upon the Status Updation of a Project.') ?></small>
                                                <form action="{{url('/settings/store_template')}}" class="form-submit-event" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <input type="hidden" name="type" value="email">
                                    ...
                                    <div class="tab-pane fade" id="email-task">
                                        ...
                                        <div class="tab-content px-0">
                                            ...
                                            <div class="tab-pane fade" id="email-task-status-updation">
                                                ...
                                                ->first();
                                                @endphp
                                                <small class="text-light fw-semibold mb-1"><?= get_label('task_status_updation_email_info', 'This Template Will Be Used for the Email Sent to the Users/Clients Upon the Status Updation of a Task.') ?></small>
                                                <form action="{{url('/settings/store_template')}}" class="form-submit-event" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <input type="hidden" name="type" value="email">
                                    ...
                                    <div class="tab-pane fade" id="email-leave-request">
                                        ...
                                        <div class="tab-content px-0">
                                            <div class="tab-pane fade show active" id="email-leave-request-creation">
                                                ...
                                                ->first();
                                                @endphp
                                                <small class="text-light fw-semibold mb-1"><?= get_label('leave_request_creation_email_info', 'This Template Will Be Used for the Email Sent to the Admin and Leave Editors Upon the Creation of a Leave Request.') ?></small>
                                                <form action="{{url('/settings/store_template')}}" class="form-submit-event" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <input type="hidden" name="type" value="email">
                                            ...
                                            <div class="tab-pane fade" id="email-leave-request-status-updation">
                                                ...
                                                ->first();
                                                @endphp
                                                <small class="text-light fw-semibold mb-1"><?= get_label('leave_request_status_updation_email_info', 'This Template Will Be Used for the Email Sent to the Admin/Leave Editors/Requestee Upon the Status Updation of a Leave Request.') ?></small>
                                                <form action="{{url('/settings/store_template')}}" class="form-submit-event" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <input type="hidden" name="type" value="email">
                            ...
                            <div class="tab-pane fade" id="sms-templates">
                                ...
                                <div class="tab-content px-0">
                                    <div class="tab-pane fade show active" id="sms-project">
                                        ...
                                        <div class="tab-content px-0">
                                            ...
                                            <div class="tab-pane fade" id="sms-project-status-updation">
                                                ...
                                                ->first();
                                                @endphp
                                                <small class="text-light fw-semibold mb-1"><?= get_label('project_status_updation_sms_info', 'This Template Will Be Used for the SMS Sent to the Users/Clients Upon the Status Updation of a Project.') ?></small>
                                                <form action="{{url('/settings/store_template')}}" class="form-submit-event" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <input type="hidden" name="type" value="sms">
                                    ...
                                    <div class="tab-pane fade show active" id="sms-task">
                                        <div class="list-group list-group-horizontal-md text-md-center">
                                        ...
                                        <div class="tab-content px-0">
                                            ...
                                            <div class="tab-pane fade" id="sms-task-status-updation">
                                                ...
                                                ->first();
                                                @endphp
                                                <small class="text-light fw-semibold mb-1"><?= get_label('task_status_updation_sms_info', 'This Template Will Be Used for the SMS Sent to the Users/Clients Upon the Status Updation of a Task.') ?></small>
                                                <form action="{{url('/settings/store_template')}}" class="form-submit-event" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <input type="hidden" name="type" value="sms">
                                    ...
                                    <div class="tab-pane fade" id="sms-leave-request">
                                        ...
                                        <div class="tab-content px-0">
                                            <div class="tab-pane fade show active" id="sms-leave-request-creation">
                                                ...
                                                ->first();
                                                @endphp
                                                <small class="text-light fw-semibold mb-1"><?= get_label('leave_request_creation_sms_info', 'This Template Will Be Used for the SMS Sent to the Admin and Leave Editors Upon the Creation of a Leave Request.') ?></small>
                                                <form action="{{url('/settings/store_template')}}" class="form-submit-event" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <input type="hidden" name="type" value="sms">
                                            ...
                                            <div class="tab-pane fade" id="sms-leave-request-status-updation">
                                                ...
                                                ->first();
                                                @endphp
                                                <small class="text-light fw-semibold mb-1"><?= get_label('leave_request_status_updation_sms_info', 'This Template Will Be Used for the SMS Sent to the Admin/Leave Editors/Requestee Upon the Status Updation of a Leave Request.') ?></small>
                                                <form action="{{url('/settings/store_template')}}" class="form-submit-event" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <input type="hidden" name="type" value="sms">
