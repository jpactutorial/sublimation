...
class AssignmentNotification extends VerifyEmailBase
{
    ...
    protected function getContent()
    {
        ...
        if (filled(Arr::get($fetched_data, 'content'))) {
            ...
            if ($this->data['type'] === 'leave_request_creation' || $this->data['type'] === 'leave_request_status_updation' || $this->data['type'] === 'project_status_updation' || $this->data['type'] === 'task_status_updation') {
